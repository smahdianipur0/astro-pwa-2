...
export function calculate_password_strength(a: number, b: number, c: number): void;
export function calculate_password_strength2(a: number, b: number, c: number): void;
